        ...
        {(() => {
            switch (helpTextKey) {
                case HelpTextKey.ADD_ITEM:
                    return (
                        <p>Items <span className="text-danger">over 35 characters</span> will be trimmed. <span className="text-success">TIP:Paste a comma separated list for quick entry.</span></p>
                    )
